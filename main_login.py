...
class Login_Window:
    def __init__(self,root):
        self.root=root
        self.root.title("Smart Attendance Login")
        ...
        img1 = Image.open("college_images/low-poly-orange-blue-background-ice-fire-theme-62856225.jpg")
        ...
        title=Label(bg_lbl,text="SMART ATTENDANCE SYSTEM",font=("times new roman",25,"bold"),bg="white",fg="#FF8C00")
        ...
        #  myname=Label(self.root,text="",fg="black",bg="white",font=("times new roman",18,"bold"))
        ...
        frame=Frame(self.root,bg="#FF8C00")
        frame.place(x=610,y=200,width=340,height=430)

        img1=Image.open("college_images/263-2636180_admin-login-png-admin-login-image-png.png")
        img1=img1.resize((90,90),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lblimg1=Label(image=self.photoimage1,bg="black",borderwidth=0)
        lblimg1.place(x=730,y=200,width=90,height=90)

        get_str=Label(frame,text="Admin Login ",font=("times new roman",20,"bold"),fg="blue",bg="#F1C40F")
        get_str.place(x=95,y=85)

        # label
        username=lbl=Label(frame,text="Username",font=("times new roman",12,"bold"),fg="blue",bg="lime")
        ...
        password=lbl=Label(frame,text="Password",font=("times new roman",12,"bold"),fg="blue",bg="lime")
        ...
        # ======Icon Images=================
        img2=Image.open("college_images/usernameicon.png")
        ...
        img3=Image.open("college_images/padlock_security_key_safeguard-512.webp")
        ...
        # LoginButton
        btn_login=Button(frame,text="Login",borderwidth=3,relief=RAISED,command=self.login,cursor="hand2",font=("times new roman",16,"bold"),fg="white",bg="lime" ,activebackground="#B00857")
        btn_login.place(x=110,y=270,width=120,height=35)
        # registerbutton
        registerbtn=Button(frame,text="New User Register",command=self.rigister_window,font=("times new roman",10,"bold"),borderwidth=0,fg="blue",bg="lime",activeforeground="white",activebackground="black")
        registerbtn.place(x=15,y=320,width=160)

        # forgetpassbtn
        registerbtn=Button(frame,text="Forget Password",command=self.forgot_password_window,font=("times new roman",10,"bold"),borderwidth=0,fg="blue",bg="lime",activeforeground="white",activebackground="black")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            messagebox.showinfo("Success","Welcome to smart attendance system",parent=self.root)
        else:
            conn=mysql.connector.connect(host="localhost",user="root",password="Prakriti@321",database="smart_attandance")
    ...
    def forgot_password_window(self):
        if self.txtuser.get()=="":
            ...
            if row==None:
                ...
                self.combo_securiy_Q["values"]=("Select","Your Birth Place","Your Best Friend,","Your Pet Name","Your Nickname")
...
class Register:
    def __init__(self,root):
        ...
        # ============bg image==================
        self.bg=ImageTk.PhotoImage(file="college_images/thumb-1920-491120.png")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)

        
        # ============left image==================
        self.bg1=ImageTk.PhotoImage(file="college_images/pngtree-internet-mobile-technology-poster-picture-image_393602.jpg")
        ...
        register_lbl=Label(frame,text="ADMIN REGISTRATION",font=("times new roman",20,"bold"),fg="darkgreen",bg="white")
