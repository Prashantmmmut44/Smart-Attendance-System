...
class ChatBot: 
    def __init__(self,root):
        ...
        img_chat=Image.open(r"college_images\0_kNNHTHs4hgALR_WR.png")
        img_chat=img_chat.resize((200,70),Image.ANTIALIAS)
        self.photoimg_chat=ImageTk.PhotoImage(img_chat)


        Title_label=Label(main_frame,bd=3,relief=RAISED,anchor='nw',width=730,image=self.photoimg_chat,compound=LEFT,text="CHAT HERE",font=("arial",30,'bold'),fg='BLUE',bg="white")
        ...
        label=Label(btn_frame,text="Type Here",fg='Red',bg='white',font=("arial",14))
        ...
        self.send=Button(btn_frame,text="Send",command=self.send,width=8,bg="Blue",fg="white",font=("times new roman",16))
        self.send.grid(row=0,column=2,sticky=W)
        

        self.clear=Button(btn_frame,text="Clear Chat ",command=self.clear,width=8,bg="lime",fg="white",font=("times new roman",15))
    ...
    def send(self):
        ...
        elif (self.e.get()=="Can you speak Hindi?"):
