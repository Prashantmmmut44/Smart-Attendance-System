...
class Attendace:
    def __init__(self,root):
        ...
        # ===============Images==================================
        img10 = Image.open("college_images/low-poly-orange-blue-background-ice-fire-theme-62856225.jpg")
        ...
        img11 = Image.open("college_images/low-poly-orange-blue-background-ice-fire-theme-62856225.jpg")
        ...
        title=Label(self.root,text="SMART ATTENDANCE SYSTEM",font=("times new roman",35,"bold"),bg="#48bf91",fg="#FF8C00")
        title.place(x=0,y=150,width=1550,height=45)

        Manage_std_frame=Frame(bg_lbl,bd=2,relief=RIDGE,bg="#FF8C00")
        ...
        #  ================Left labelframe=================
        DataFrameLeft=LabelFrame(Manage_std_frame,bd=4,padx=2,relief=RIDGE,fg="blue",bg="#48bf91",
                                                font=("arial",12,"bold"),text="Student Info")
        DataFrameLeft.place(x=5,y=0,width=960,height=880)

        updateframe=Frame(DataFrameLeft,bd=2,relief=RIDGE,bg="#48bf91")
        updateframe.place(x=5,y=150,width=635,height=300)

        img30 = Image.open("college_images/low-poly-orange-blue-background-ice-fire-theme-62856225.jpg")
        ...
        ButtonFrame1.place(x=0,y=170,width=1030,height=380)

        btnAddData=Button(ButtonFrame1,text="Import csv",command=self.importData,font=("arial",11,"bold"),width=16,bg="#FF8C00",fg="white")
        btnAddData.grid(row=0,column=2,padx=1)

        btnUpdate=Button(ButtonFrame1,text="Export csv",command=self.export_data,font=("arial",11,"bold"),width=16,bg="#FF8C00",fg="white")
        btnUpdate.grid(row=0,column=3,padx=1)

        btnDelete=Button(ButtonFrame1,text="Update",command=self.action,font=("arial",11,"bold"),width=16,bg="#FF8C00",fg="white")
        btnDelete.grid(row=0,column=0,padx=1)

        btnReset=Button(ButtonFrame1,text="Reset",command=self.clear,font=("arial",11,"bold"),width=16,bg="#FF8C00",fg="white")
        btnReset.grid(row=0,column=1,padx=1)

        #  ================Right labelframe=================
        DataFrameRight=LabelFrame(Manage_std_frame,bd=4,padx=2,relief=RIDGE,bg="#48bf91",fg="blue",
                                                font=("arial",12,"bold"),text="Student Details")
        DataFrameRight.place(x=670,y=0,width=600,height=480)
    ...
    # ======RETURN=========
        btnback=Button(title,text="RETURN",command=self.go_back,font=("arial",11,"bold"),width=17,bg="white",fg="#FF8C00")
    ...
    def fetch_data(self):
        conn=mysql.connector.connect(host="localhost",username="root",password="Prakriti@321",database="smart_attandance")
