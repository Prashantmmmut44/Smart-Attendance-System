...
class Developer:
    def __init__(self,root):
        ...
        img1 = Image.open(r"college_images\prince.jpg")
        ...
        img111 = img111.resize((600,600), Image.ANTIALIAS)
        ...
        support=Label(Manage_std_frame1,bg="black",fg="white",text="HI",font=("times new roman",17,"bold"))
        support.place(x=10,y=10)

        support=Label(Manage_std_frame1,bg="black",fg="blue",text="Prashant Srivastava",font=("times new roman",22,"bold"))
        support.place(x=10,y=45)

        support=Label(Manage_std_frame1,bg="black",fg="white",text="MCA 3RD YEAR STUDENT",font=("arial",12,"bold"))
        support.place(x=10,y=110)

        support=Label(Manage_std_frame1,bg="black",fg="White",text="MADAN MOHAN MALVIYA UNIVERSITY OF TECHNOLOGY",font=("arial",12,"bold"))
        support.place(x=10,y=140)

        support=Label(Manage_std_frame1,bg="black",fg="blue",text="https://www.linkedin.com/in/prashant-srivastava-99b234196/",font=("arial",12,"bold"))
