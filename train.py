...
class Train_Data:
    def __init__(self,root):
        ...
        img_logo = Image.open("college_images/face scanner.png")
        ...
        img_logo11 = Image.open("college_images/di.jpg")
        ...
        b3 =Button(self.root,text="TRAIN DATA",command=self.train_classifier,borderwidth=15,font=("times new roman",25,"bold"),bg="#FF8C00",activebackground="red",fg="white",cursor="hand2")
        ...
        btnReset=Button(title,text="RETURN",command=self.go_back,font=("arial",11,"bold"),width=17,bg="white",fg="#FF8C00")
