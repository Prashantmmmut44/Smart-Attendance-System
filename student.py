...
class Student:
    def __init__(self, root):
        ...
        self.root.title("Manage Student Department")
        self.root.config(bg="#FF8C00")
        ...
        # ===============Images==================================
        img10 = Image.open(
            "college_images/low-poly-orange-blue-background-ice-fire-theme-62856225.jpg")
        ...
        Manage_std_frame = Frame(self.root, bd=2, relief=RIDGE, bg="#FF8C00")
        Manage_std_frame.place(x=0, y=90, width=1250, height=600)

        # ==================== Project title ==================================================
        title = Label(self.root, text="SMART ATTENDANCE SYSTEM", font=(
            "times new roman", 30, "bold"), bg="white", fg="#FF8C00")
        title.place(x=0, y=60, width=1250, height=35)

        img_logo = Image.open(
            "college_images/India-flag-icon-on-transparent-background-PNG.png")
        ...
        lbl = Label(title, font=('times new roman', 16, 'bold'),
        ...
        DataFrameLeft = LabelFrame(Manage_std_frame, bd=4, padx=2, relief=RIDGE, fg="#FF8C00", bg="white",
                                   font=("arial", 12, "bold"), text="Student Info ")
        DataFrameLeft.place(x=10, y=10, width=660, height=580)

        #  ================Right labelframe=================
        DataFrameRight = LabelFrame(Manage_std_frame, bd=4, padx=2, relief=RIDGE, bg="white", fg="#FF8C00",
        ...
        # ReferenceID
        referance_id = Label(myimg, font=("arial", 12, "bold"),
                             text="Reference  No:", bg="#FF8C00")
        referance_id.place(x=0, y=53)

        txt_refid = ttk.Entry(myimg, textvariable=self.ref_id, width=8, font=(
            "arial", 12, "bold"), state=DISABLED)
        txt_refid.place(x=125, y=53)

        # Curent course Information labelFrame
        std_Info_label_frame = LabelFrame(DataFrameLeft, padx=10, bd=2, relief=RIDGE, font=(
            "times new roman", 11, "bold"), fg="blue", bg="#48bf91", text="Current Course Information")
        std_Info_label_frame.place(x=1, y=80, width=650, height=115)

        # label and entries
        # department

        lbl_dep = Label(std_Info_label_frame, font=(
            "arial", 12, "bold"), text="Department:", bg="#FF8C00")
        ...
        com_dep['value'] = ("Select Department", "CS", "Mechnical",
                            "Civil", "Electonic", "Electrical", "Automobile", "IT")
        com_dep.current(0)
        com_dep.grid(row=0, column=1, sticky=W, padx=2)

        # course
        course_std = Label(std_Info_label_frame, font=(
            "arial", 12, "bold"), text="Courses:", bg="#FF8C00")
        ...
        # year
        currunt_year = Label(std_Info_label_frame, font=(
            "arial", 12, "bold"), text="Year:", bg="#FF8C00")
        ...
        # semster
        label_Semester = Label(std_Info_label_frame, font=(
            "arial", 12, "bold"), text="Semester:", bg="#FF8C00")
        ...
        std_personalData_label_frame = LabelFrame(DataFrameLeft, padx=10, pady=5, bd=2, relief=RIDGE, font=(
            "times new roman", 11, "bold"), fg="blue", bg="#48bf91", text="Student Class Information")
        std_personalData_label_frame.place(x=1, y=195, width=650, height=260)

        lbl_id = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="StudentID No:", bg="white")
        lbl_id.grid(row=0, column=0, sticky=W, padx=2, pady=7)

        txt_id = ttk.Entry(std_personalData_label_frame,
                           textvariable=self.va_std_id, width=22, font=("arial", 11, "bold"))
        txt_id.grid(row=0, column=1, padx=2, pady=7)

        lbl_Name = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Student Name:", bg="white")
        lbl_Name.grid(row=0, column=2, sticky=W, padx=2, pady=7)

        txt_name = ttk.Entry(std_personalData_label_frame,
                             textvariable=self.var_std_name, width=22, font=("arial", 11, "bold"))
        txt_name.grid(row=0, column=3, padx=2, pady=7)

        lbl_div = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Class Division:", bg="white")
        ...
        lbl_roll = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Roll No:", bg="white")
        lbl_roll.grid(row=1, column=2, sticky=W, padx=2, pady=7)

        txt_roll = ttk.Entry(std_personalData_label_frame,
                             textvariable=self.var_roll, width=22, font=("arial", 11, "bold"))
        txt_roll.grid(row=1, column=3, padx=2, pady=7)

        lbl_gender = Label(std_personalData_label_frame, font=(
        ...
        lbl_dob = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="DOB:", bg="white")
        lbl_dob.grid(row=2, column=2, sticky=W, padx=2, pady=7)

        txt_dob = ttk.Entry(std_personalData_label_frame,
                            textvariable=self.var_dob, width=22, font=("arial", 11, "bold"))
        txt_dob.grid(row=2, column=3, padx=2, pady=7)

        lbl_email = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Email:", bg="white")
        lbl_email.grid(row=3, column=0, sticky=W, padx=2, pady=7)

        txt_email = ttk.Entry(std_personalData_label_frame,
                              textvariable=self.var_email, width=22, font=("arial", 11, "bold"))
        txt_email.grid(row=3, column=1, padx=2, pady=7)

        lbl_phone = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Phone No:", bg="white")
        lbl_phone.grid(row=3, column=2, sticky=W, padx=2, pady=7)

        txt_phone = ttk.Entry(std_personalData_label_frame,
                              textvariable=self.var_phone, width=22, font=("arial", 11, "bold"))
        txt_phone.grid(row=3, column=3, padx=2, pady=7)

        lbl_adderss = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Address:", bg="white")
        lbl_adderss.grid(row=4, column=0, sticky=W, padx=2, pady=7)

        txt_adderss = ttk.Entry(std_personalData_label_frame,
                                textvariable=self.var_address, width=22, font=("arial", 11, "bold"))
        txt_adderss.grid(row=4, column=1, padx=2, pady=7)

        lbl_teacher = Label(std_personalData_label_frame, font=(
            "arial", 12, "bold"), text="Teacher Name:", bg="white")
        lbl_teacher.grid(row=4, column=2, sticky=W, padx=2, pady=7)

        txt_teacher = ttk.Entry(std_personalData_label_frame,
                                textvariable=self.var_teacher, width=22, font=("arial", 11, "bold"))
        txt_teacher.grid(row=4, column=3, padx=2, pady=7)

        # radio buttons
        self.usertype = StringVar()
        radiobtn1 = ttk.Radiobutton(
            std_personalData_label_frame, text="Take Photo Smaple", value="Yes", variable=self.usertype)
        radiobtn1.grid(row=5, column=0, pady=10)

        radiobtn2 = ttk.Radiobutton(
            std_personalData_label_frame, text="No Photo Smaple", value="No", variable=self.usertype)
        ...
        youimg = Label(std_personalData_label_frame,
                       image=self.photoImg50, bd=2, relief=RIDGE)
        ...
        # ===================================ButtonFrame=====================================
        btnAddData = Button(ButtonFrame2, text="UPDATE", command=self.std_update, font=(
            "arial", 11, "bold"), width=23, bg="#FF8C00", fg="white")
        btnAddData.grid(row=0, column=0, padx=1)

        btnUpdate = Button(ButtonFrame2, text="DELETE", command=self.std_delete, font=(
            "arial", 11, "bold"), width=23, bg="#FF8C00", fg="white")
        btnUpdate.grid(row=0, column=1, padx=1)

        btnDelete = Button(ButtonFrame2, text="RESET", command=self.clear, font=(
            "arial", 11, "bold"), width=23, bg="#FF8C00", fg="white")
        ...
        btnPhoto = Button(ButtonFrame1, text="SAVE STUDENT DETAILS", command=self.generate_dataset, font=(
            "arial", 11, "bold"), width=72, bg="#FF8C00", fg="white")
        ...
        # =======table&search=====================================================================================
        Table_frame = LabelFrame(DataFrameRight, text="View Student Details", font=(
            "arial", 11, "bold"), bg="#48bf91", bd=3, relief=RIDGE)
        Table_frame.place(x=0, y=200, width=570, height=70)

        # ==========Search By========
        lblSearch = Label(Table_frame, font=("arial", 11, "bold"),
                          text="Search By", padx=2, bg="#FF8C00", fg="white")
        lblSearch.grid(row=0, column=2, sticky=W, padx=5)

        # variable
        self.serch_var = StringVar()
        search_combo = ttk.Combobox(Table_frame, width=12, textvariable=self.serch_var, font=(
            "times new roman", 11), state="readonly")
        search_combo['values'] = (
            "Select Option", "phone", "roll", "department")
        search_combo.grid(row=0, column=3, sticky=W, padx=5)
        search_combo.current(0)

        self.serchTxt_var = StringVar()
        txtSearch = ttk.Entry(
            Table_frame, width=16, textvariable=self.serchTxt_var, font=("times new roman", 10))
        txtSearch.grid(row=0, column=4, padx=5)

        btnExit = Button(Table_frame, text="SEARCH", command=self.search_data, font=(
            "arial", 12, "bold"), width=10, bg="#FF8C00", fg="white")
        btnExit.grid(row=0, column=5, padx=5)

        btnExit = Button(Table_frame, text="SHOW ALL", command=self.fetch_data, font=(
            "arial", 12, "bold"), width=10, bg="#FF8C00", fg="white")
        ...
        btnReset = Button(title, text="RETURN", command=self.go_back, font=(
            "arial", 11, "bold"), width=17, bg="white", fg="red")
        ...
        if (self.var_dep.get() == "Select Department" or self.var_course.get() == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_roll.get() == "" or self.usertype.get() == ""):
            ...
            try:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="Prakriti@321", database="smart_attandance")
                ...
                engine.runAndWait()
                messagebox.showinfo(
                    "Suceess", f"Student has been added...!!!!", parent=self.root)
    ...
    def generate_dataset(self):
        if (self.var_dep.get() == "Select Department" or self.var_course.get() == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_roll.get() == "" or self.usertype.get() == ""):
            messagebox.showinfo(
                "Result", "Please provide complete details  of the user", parent=self.root)
        else:
            conn = mysql.connector.connect(
                host='localhost', username='root', password='Prakriti@321', database='smart_attandance')
            my_cursor = conn.cursor()
            ...
            while True:
                ...
                if face_cropped(frame) is not None:
                    ...
                    file_name_path = "collect_sample/user." + \
                        str(id)+"."+str(self.img_id)+".jpg"
                    cv2.imwrite(file_name_path, face)
                    cv2.putText(face, str(self.img_id), (50, 50),
            ...
            messagebox.showinfo(
                "Result", "Generatig datasets completed!!!", parent=self.root)
    ...
    def std_update(self):
        if (self.var_dep.get() == "Select Department" or self.var_course.get() == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_roll.get() == "" or self.usertype.get() == ""):
            messagebox.showwarning(
                "Warning", "All fields are required", parent=self.root)
        else:
            try:
                update = messagebox.askyesno(
                    "Success", "Are you sure you want  to update this Student", parent=self.root)
                if update > 0:
                    conn = mysql.connector.connect(
                        host="localhost", username="root", password="Prakriti@321", database="smart_attandance")
                    my_cursor = conn.cursor()
                    ...
                    if not update:
                        return
                messagebox.showinfo(
                    "Success", "Student successfully update completed....!!!", parent=self.root)
                conn.commit()
                self.fetch_data()
                self.clear()
                conn.close()
    ...
    def std_delete(self):
        if self.ref_id.get() == 0:
            messagebox.showerror(
                "Error", "Reference Id must be reqaired", parent=self.root)
        else:
            emp_delete = messagebox.askyesno(
                "Facial Attendance Management System", "Do you delete this student", parent=self.root)
            if emp_delete > 0:
                conn = mysql.connector.connect(
                    host="localhost", username="root", password="Prakriti@321", database="smart_attandance")
                my_cursor = conn.cursor()
    ...
    def search_data(self):
        if self.serchTxt_var.get() == "" or self.serch_var.get() == "Select Option":
            messagebox.showerror(
                "Error", "Select Combo option and enter entry box", parent=self.root)
        else:
            try:
                conn = mysql.connector.connect(
                    host='localhost', username='root', password='Prakriti@321', database='smart_attandance')
                my_cursor = conn.cursor()
                my_cursor.execute("select * from new_student where " + str(
                    self.serch_var.get())+" LIKE '%"+str(self.serchTxt_var.get())+"%'")
